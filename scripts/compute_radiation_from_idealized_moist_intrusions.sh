...
odir=${wdir}/output/rad_profiles/idealized_profiles_moist_intrusions_20200213lower
h2o_only=False
...
python createIdealizedMoistureProfiles_MoistIntrusions_20200213lower.py --out_dir=${odir}/${subdir} --h2o_only=${h2o_only}
