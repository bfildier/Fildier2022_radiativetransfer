...
def concat(input_dir):
    ...
    # for rad_path in all_rad_path[:5]:
        ...
        if (compute_q_rad == True):
            ...
            if args.interp:
                ...
                sonde = sonde.interp(zlev=np.arange(5,10005,10)).interp(zlay=np.arange(0,10010,10)) 
    ...
    print(all_rad_files[0])

    all_rad_files = xr.concat(all_rad_files, dim="index")
